...
db.run('CREATE TABLE IF NOT EXISTS "blog_post" ("id" integer NOT NULL PRIMARY KEY AUTOINCREMENT, "text" text, "short" varchar(120), "title" varchar(140) NOT NULL, "image" varchar(100), "status" varchar(1) NOT NULL DEFAULT 0, "date" datetime NOT NULL, "author" varchar(140) NOT NULL)');
